    ...
    return Container(
      ...
      decoration: BoxDecoration(
          border: BorderDirectional(
              bottom: BorderSide(color: designColors[20], width: 3))),
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(nickName,
                  style: TextStyle(fontSize: 20, color: designColors[21])),
              const SizedBox(
                height: 8,
              ),
              IconTextContainer(
                  width: 154,
                  image: FaIcon(FontAwesomeIcons.solidClock,
                      color: designColors[21], size: 15),
