...
import 'package:project_2/kid_game_view/lessons_unit.dart';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Logical reasoning",
                    style: TextStyle(fontSize: 25, fontFamily: "Roboto-Black"),
                  ),
                  SizedBox(width: 15),
                  Image.asset(
                ...
                unitButton(
                  ...
                  () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => LessonsUnit()));
                    print("next page");
                  },
                  3,
                  40,
